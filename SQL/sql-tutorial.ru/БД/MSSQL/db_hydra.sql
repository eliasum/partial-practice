...
GO
CREATE TABLE [hydadm].[Battles] (
    [name] [varchar] (20) NOT NULL ,
    [date] [datetime] NOT NULL
) ON [PRIMARY]
GO
 
CREATE TABLE [hydadm].[Classes] (
...
ALTER TABLE [hydadm].[Battles] ADD
...
ALTER TABLE [hydadm].[Classes] ADD
...
ALTER TABLE [hydadm].[Outcomes] ADD
...
CREATE TABLE [hydadm].[utQ] (
    [Q_ID] [int] NOT NULL ,
    [Q_NAME] [varchar] (35) NOT NULL
) ON [PRIMARY]
GO
 
CREATE TABLE [hydadm].[utV] (
    [V_ID] [int] NOT NULL ,
...
ALTER TABLE [hydadm].[utB] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[utQ] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[utV] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[utB] ADD
    ...
    CONSTRAINT [hydadm].[FK_utB_utV] FOREIGN KEY
    (
        [B_V_ID]
    ) REFERENCES [utV] (
        [V_ID]
...
ALTER TABLE [Income] WITH NOCHECK ADD
...
ALTER TABLE [Outcome] WITH NOCHECK ADD
...
ALTER TABLE [Income_o] WITH NOCHECK ADD
...
ALTER TABLE [Outcome_o] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Laptop] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[PC] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Product] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Printer] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Printer] ADD
...
----PC_------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
insert into PC_ values(1,'1232',500,64,5,'12x',600)
insert into PC_ values(2,'1121',750,128,14,'40x',850)
insert into PC_ values(3,'1233',500,64,5,'12x',600)
insert into PC_ values(4,'1121',600,128,14,'40x',850)
insert into PC_ values(5,'1121',600,128,8,'40x',850)
insert into PC_ values(6,'1233',750,128,20,'50x',950)
insert into PC_ values(7,'1232',500,32,10,'12x',400)
insert into PC_ values(8,'1232',450,64,8,'24x',350)
insert into PC_ values(9,'1232',450,32,10,'24x',350)
insert into PC_ values(10,'1260',500,32,10,'12x',350)
insert into PC_ values(11,'1233',900,128,40,'40x',980)
insert into PC_ values(12,'1233',800,128,20,'50x',970)
...
CREATE TABLE [hydadm].[Company] (
    [ID_comp] [int] NOT NULL ,
    [name] [char] (10) NOT NULL
)
GO
 
CREATE TABLE [hydadm].[Pass_in_trip] (
...
CREATE TABLE [hydadm].[Passenger] (
    [ID_psg] [int] NOT NULL ,
    [name] [char] (20) NOT NULL
)
GO
 
CREATE TABLE [hydadm].[Trip] (
    [trip_no] [int] NOT NULL ,
    [ID_comp] [int] NOT NULL ,
...
ALTER TABLE [hydadm].[Company] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Pass_in_trip] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Passenger] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Trip] WITH NOCHECK ADD
...
ALTER TABLE [hydadm].[Pass_in_trip] ADD
