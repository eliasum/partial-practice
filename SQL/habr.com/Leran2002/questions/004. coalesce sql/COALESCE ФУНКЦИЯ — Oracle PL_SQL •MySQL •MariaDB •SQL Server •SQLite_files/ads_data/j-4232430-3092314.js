//Generated:2021-03-31 07:09:54// 6-244
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4232430 || '',
    guid: window.ftGUID_4232430 || '',
    confID: window.ftConfID_4232430 || '0',
    ftReturn: window.ftReturn_4232430 || '',
    keyword: window.ftKeyword_4232430 || '',
    ftId: window.ftId_4232430 || '',
    ftImpId: window.ftImp4232430 && window.ftImp4232430.impID || '',
    gdpr: window.ftImp4232430 && window.ftImp4232430.gdpr || '',
    gdpr_consent: window.ftImp4232430 && window.ftImp4232430.gdpr_consent || '',
    gdpr_pd: window.ftImp4232430 && window.ftImp4232430.gdpr_pd || '',
    us_privacy: window.ftImp4232430 && window.ftImp4232430.us_privacy || '',
    campaignID: '115845',
    cID: '100963',
    pID: '4232430',
    creativeID: '3092314',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115845&sid=18330&plc=4232430&num=&adid=&advid=&adsrv=29&btreg=4232430&btadsrv=flashtalking&crt=3092314&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/115845;4232430;3092314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/ru/creativecloud/plans.html?plan=individual&locale=ru?sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?181425221-4232430;3092314;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/423/4232430/3092314/image/3092314.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115845;4232430;202;pixel;DV360;DV360FY20CCBEHAffinityRUDSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/115845;4232430;3092314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/ru/creativecloud/plans.html?plan=individual&locale=ru?sdid=GZKZY1B7&mv=display',
    divID: 'ftdiv4232430',
    altimgID: 'ftalt4232430',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4232430 && parseInt(window.ftImp4232430.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4232430') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4232430'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4232430").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4232430").style.display = "none";
		    }
		});
	}
}(ft4232430));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115845&l2=DV360&l3=4232430&l4=3092314&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115845&l2=DV360&l3=4232430&l4=3092314&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
