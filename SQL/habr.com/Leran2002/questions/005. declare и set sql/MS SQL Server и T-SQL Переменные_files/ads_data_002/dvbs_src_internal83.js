...
function dv_handler132(){function A(b){try{var c=new URL(b);return!c.pathname||""==c.pathname||"/"==c.pathname}catch(f){}}function G(b){var c=window._dv_win,f=0;try{for(;10>f;){if(c[b]&&"object"===typeof c[b])return!0;if(c==c.parent)break;f++;c=c.parent}}catch(e){}return!1}function H(){var b="http:";"http:"!=window._dv_win.location.protocol&&(b="https:");return b}function B(b,c){var f=document.createElement("iframe");f.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+w();f.width=0;f.height=
0;f.id=c;f.style.display="none";f.src=b;return f}function x(b,c,f){f=f||150;var e=window._dv_win||window;if(e.document&&e.document.body)return c&&c.parentNode?c.parentNode.insertBefore(b,c):e.document.body.insertBefore(b,e.document.body.firstChild),!0;if(0<f)setTimeout(function(){x(b,c,--f)},20);else return!1}function I(b){var c=window._dv_win.dv_config=window._dv_win.dv_config||{};c.cdnAddress=c.cdnAddress||"cdn.doubleverify.com";return'<html><head><script type="text/javascript">('+function(){try{window.$dv=
window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(f){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+(b||"function() {}")+')("'+c.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function C(b){var c=0,f;for(f in b)b.hasOwnProperty(f)&&++c;return c}function J(b,c){a:{var f={};try{if(b&&b.performance&&b.performance.getEntries){var e=b.performance.getEntries();for(b=0;b<e.length;b++){var d=
e[b],k=d.name.match(/.*\/(.+?)\./);if(k&&k[1]){var m=k[1].replace(/\d+$/,""),g=c[m];if(g){for(var h=0;h<g.stats.length;h++){var t=g.stats[h];f[g.prefix+t.prefix]=Math.round(d[t.name])}delete c[m];if(!C(c))break}}}}var l=f;break a}catch(D){}l=void 0}if(l&&C(l))return l}function K(b,c){var f,e=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(d){var k=window._dv_win.$dvbs;if(k){var m=c?"https:":H();f=d.ImpressionID;k.tags.add(d.ImpressionID,b);k.tags[d.ImpressionID].set({tagElement:b.script,
impressionId:d.ImpressionID,dv_protocol:b.protocol,protocol:m,uid:b.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});b.script&&b.script.dvFrmWin&&(b.script.dvFrmWin.$uid=d.ImpressionID,k.messages&&k.messages.startSendingEvents&&k.messages.startSendingEvents(b.script.dvFrmWin,d.ImpressionID));(function(){function c(){var f=window._dv_win.document.visibilityState;"prerender"===e&&"prerender"!==f&&"unloaded"!==f&&(e=f,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),
window._dv_win.document.removeEventListener(b,c))}if("prerender"===e)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0});else{var b;"undefined"!==typeof window._dv_win.document.hidden?b="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?b="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?b="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&
(b="webkitvisibilitychange");window._dv_win.document.addEventListener(b,c,!1)}})()}if("1"!=b.foie)try{var g=J(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});g&&window._dv_win.$dvbs.registerEventCall(d.ImpressionID,g)}catch(h){}};window[b.callbackName]=function(d){try{u.setIsJSONPCalled(!0)}catch(g){}var c=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[f]?window._dv_win.$dvbs.tags[f]:b;var e=window._dv_win.dv_config.bs_renderingMethod||function(d){document.write(d)};
...
hasPassback:!1,tagAdTag:c,tagPassback:f}};return d(b)}function E(b,c,f,e,d,k,m,g,h,t,l,D){void 0==c.dvregion&&(c.dvregion=0);try{e.depth=M(e);var q=N(e);var n="&aUrl="+encodeURIComponent(q.url);var p="&aUrlD="+q.depth;var v=e.depth+d;k&&e.depth--}catch(F){p=n=v=e.depth=""}void 0!=c.aUrl&&(n="&aUrl="+c.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var r=1;break a}}catch(F){}r=0}k=function(){function b(d){c++;var e=d.parent==d;return d.mraid||e?d.mraid:20>=c&&b(d.parent)}
var d=window._dv_win||window,c=0;try{return b(d)}catch(X){}}();d=c.script.src;r="&ctx="+(dv_GetParam(d,"ctx")||"")+"&cmp="+(dv_GetParam(d,"cmp")||"")+"&plc="+(dv_GetParam(d,"plc")||"")+"&sid="+(dv_GetParam(d,"sid")||"")+"&advid="+(dv_GetParam(d,"advid")||"")+"&adsrv="+(dv_GetParam(d,"adsrv")||"")+"&unit="+(dv_GetParam(d,"unit")||"")+"&isdvvid="+(dv_GetParam(d,"isdvvid")||"")+"&uid="+c.uid+"&tagtype="+(dv_GetParam(d,"tagtype")||"")+"&adID="+(dv_GetParam(d,"adID")||"")+"&app="+(dv_GetParam(d,"app")||
"")+"&sup="+(dv_GetParam(d,"sup")||"")+"&isovv="+r+"&gmnpo="+(dv_GetParam(d,"gmnpo")||"")+"&crt="+(dv_GetParam(d,"crt")||"");"1"==dv_GetParam(d,"foie")&&(r+="&foie=1");k&&(r+="&ismraid=1");(k=dv_GetParam(d,"xff"))&&(r+="&xff="+k);(k=dv_GetParam(d,"vssd"))&&(r+="&vssd="+k);(k=dv_GetParam(d,"apifw"))&&(r+="&apifw="+k);(k=dv_GetParam(d,"vstvr"))&&(r+="&vstvr="+k);(k=dv_GetParam(d,"tvcp"))&&(r+="&tvcp="+k);l&&(r+="&dvp_sfr=1");D&&(r+="&dvp_sfe=1");(l=dv_GetParam(d,"useragent"))&&(r+="&useragent="+l);
r+="&dup="+dv_GetParam(d,"dup");void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent?l={ID:window._dv_win.$dvbs.CommonData.BrowserId,version:window._dv_win.$dvbs.CommonData.BrowserVersion,ID_UA:window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent}:(l=O(l?decodeURIComponent(l):navigator.userAgent),window._dv_win.$dvbs.CommonData.BrowserId=l.ID,window._dv_win.$dvbs.CommonData.BrowserVersion=
l.version,window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=l.ID_UA);r+="&brid="+l.ID+"&brver="+l.version+"&bridua="+l.ID_UA;try{r+=dv_AppendIQPAParams(d)}catch(F){}(l=dv_GetParam(d,"turl"))&&(r+="&turl="+l);(l=dv_GetParam(d,"tagformat"))&&(r+="&tagformat="+l);r+=P();t=t?"&dvf=0":"";l=G("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||c.protocol+"//"+(window._dv_win.dv_config.bsAddress||"rtb"+c.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+c.callbackName+"&jsTagObjCallback="+
c.tagObjectCallbackName+"&num=6"+r+"&srcurlD="+e.depth+"&ssl="+c.ssl+t+l+"&refD="+v+c.tagIntegrityFlag+c.tagHasPassbackFlag+"&htmlmsging="+(m?"1":"0");(e=dv_GetDynamicParams(d,"dvp").join("&"))&&(c+="&"+e);(e=dv_GetDynamicParams(d,"dvpx").join("&"))&&(c+="&"+e);if(!1===g||h)c=c+("&dvp_isBodyExistOnLoad="+(g?"1":"0"))+("&dvp_isOnHead="+(h?"1":"0"));f="srcurl="+encodeURIComponent(f);(g=Q())&&(f+="&ancChain="+encodeURIComponent(g));g=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&
(g=2E3);if(h=dv_GetParam(d,"referrer"))h="&referrer="+h,c.length+h.length<=g&&(c+=h);(h=dv_GetParam(d,"prr"))&&(c+="&prr="+h);(h=dv_GetParam(d,"iframe"))&&(c+="&iframe="+h);(h=dv_GetParam(d,"gdpr"))&&(c+="&gdpr="+h);(h=dv_GetParam(d,"gdpr_consent"))&&(c+="&gdpr_consent="+h);n.length+p.length+c.length<=g&&(c+=p,f+=n);(n=R())&&(c+="&m1="+n);(n=S())&&0<n.f&&(c+="&bsig="+n.f,c+="&usig="+n.s);n=T();0<n&&(c+="&hdsig="+n);navigator&&navigator.hardwareConcurrency&&(c+="&noc="+navigator.hardwareConcurrency);
c+=U();n=V();c+="&vavbkt="+n.vdcd;c+="&lvvn="+n.vdcv;""!=n.err&&(c+="&dvp_idcerr="+encodeURIComponent(n.err));"prerender"===window._dv_win.document.visibilityState&&(c+="&prndr=1");(d=dv_GetParam(d,"wrapperurl"))&&1E3>=d.length&&c.length+d.length<=g&&(c+="&wrapperurl="+d);c+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(y(f));c=c.length+b.length<=g?c+b:c+"&dvf=3";return{isSev1:!1,url:c}}function P(){var b="";try{var c=window._dv_win.parent;b+="&chro="+(void 0===c.chrome?
"0":"1");b+="&hist="+(c.history?c.history.length:"");b+="&winh="+c.innerHeight;b+="&winw="+c.innerWidth;b+="&wouh="+c.outerHeight;b+="&wouw="+c.outerWidth;c.screen&&(b+="&scah="+c.screen.availHeight,b+="&scaw="+c.screen.availWidth)}catch(f){}return b}function V(){var b=[],c=function(b){e(b,null!=b.AZSD,9);e(b,b.location.hostname!=b.encodeURIComponent(b.location.hostname),10);e(b,null!=b.cascadeWindowInfo,11);e(b,null!=b._rvz,32);e(b,null!=b.FO_DOMAIN,34);e(b,null!=b.va_subid,36);e(b,b._GPL&&b._GPL.baseCDN,
40);e(b,f(b,"__twb__")&&f(b,"__twb_cb_"),43);e(b,null!=b.landingUrl&&null!=b.seList&&null!=b.parkingPPCTitleElements&&null!=b.allocation,45);e(b,f(b,"_rvz",function(b){return null!=b.publisher_subid}),46);e(b,null!=b.cacildsFunc&&null!=b.n_storesFromFs,47);e(b,b._pcg&&b._pcg.GN_UniqueId,54);e(b,f(b,"__ad_rns_")&&f(b,"_$_"),64);e(b,null!=b.APP_LABEL_NAME_FULL_UC,71);e(b,null!=b._priam_adblock,81);e(b,b.supp_ads_host&&b.supp_ads_host_overridden,82);e(b,b.uti_xdmsg_manager&&b.uti_xdmsg_manager.cb,87);
e(b,b.LogBundleData&&b.addIframe,91);e(b,b.xAdsXMLHelperId||b.xYKAffSubIdTag,95);e(b,b.__pmetag&&b.__pmetag.uid,98);e(b,b.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(b.supp_ads_host_overridden),100)},f=function(b,c,e){for(var d in b)if(-1<d.indexOf(c)&&(!e||e(b[d])))return!0;return!1},e=function(c,e,f){e&&-1==b.indexOf(f)&&b.push((c==window.top?-1:1)*f)};try{return function(){for(var b=window,e=0;10>e&&(c(b),b!=window.top);e++)try{b.parent.document&&(b=b.parent)}catch(m){break}}(),
{vdcv:28,vdcd:b.join(","),err:void 0}}catch(d){return{vdcv:28,vdcd:"-999",err:d.message||"unknown"}}}function M(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function N(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var f,e=1,d=0;0<e&&100>d;){try{if(d++,f=c.shift(),e--,0<f.win.location.toString().length&&f.win!=b)return 0==f.win.document.referrer.length||0==f.depth?{url:f.win.location,depth:f.depth}:{url:f.win.document.referrer,
depth:f.depth-1}}catch(g){}var k=f.win.frames.length;for(var m=0;m<k;m++)c.push({win:f.win.frames[m],depth:f.depth+1}),e++}return{url:"",depth:""}}catch(g){return{url:"",depth:""}}}function Q(){var b=window._dv_win[y("=@42E:@?")][y("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var f=0;f<b.length;f++)c[f+1]=b[f];return c.reverse().join(",")}return null}function y(b){new String;var c=new String,f;for(f=0;f<b.length;f++){var e=
b.charAt(f);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=d&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));c+=e}return c}function w(){return Math.floor(1E12*(Math.random()+""))}function O(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},
...
var b=!1;try{var c=document.createElement("p");c.innerText=".";c.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";b=void 0!=c.style.textShadow}catch(f){}return(0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")||window.webkitAudioPannerNode&&window.webkitConvertPointFromNodeToPage)&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(f){return 0}}function R(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},f=function(b,c){return function(){return b.apply(c,
arguments)}},e="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):e?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},k=["Moz","O","ms","Webkit"],m=["moz","o","ms","webkit"],g={style:d("modernizr").style},h=function(b,c){function e(){h&&(delete g.style,delete g.modElem)}var f;for(f=["modernizr","tspan","samp"];!g.style&&
f.length;){var h=!0;g.modElem=d(f.shift());g.style=g.modElem.style}var l=b.length;for(f=0;f<l;f++){var k=b[f];~(""+k).indexOf("-")&&(k=cssToDOM(k));if(void 0!==g.style[k])return e(),"pfx"==c?k:!0}e();return!1},t=function(b,c,d){var e=b.charAt(0).toUpperCase()+b.slice(1),l=(b+" "+k.join(e+" ")+e).split(" ");if("string"===typeof c||"undefined"===typeof c)return h(l,c);l=(b+" "+m.join(e+" ")+e).split(" ");for(var g in l)if(l[g]in c){if(!1===d)return l[g];b=c[l[g]];return"function"===typeof b?f(b,d||
c):b}return!1};c(0,!0);c(1,t("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,t("shapeOutside","content-box",!0));return b}catch(l){return 0}}function z(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(f){}return b}function S(){try{var b=z(),c=0,f=0,e=function(b,d,e){e&&(c+=Math.pow(2,b),f+=Math.pow(2,d))},d=b.document;e(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));e(14,1,(b.CustomWLAdServer||
...
d.querySelector('path[id="cp-search-0"]'));e(20,13,function(){try{if(b.top==b&&0<b.document.getElementsByClassName("asu").length)for(var c=b.document.styleSheets,d=0;d<c.length;d++)for(var e=b.document.styleSheets[d].cssRules,f=0;f<e.length;f++)if("div.kk"==e[f].selectorText||"div.asu"==e[f].selectorText)return!0}catch(p){}}());a:{try{var k=null!=d.querySelector('div[id="kt_player"][hiegth]');break a}catch(l){}k=void 0}e(21,14,k);a:{try{var m=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');
break a}catch(l){}m=void 0}e(22,15,m);a:{try{var g=d.querySelector('object[data*="/VPAIDFlash.swf"]')&&d.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&d.querySelector('div[id*="desktopSubModal"]');break a}catch(l){}g=void 0}e(25,16,g);var h=navigator.userAgent;if(h&&-1<h.indexOf("Android")&&-1<h.indexOf(" wv)")&&b==window.top){var t=d.querySelector('img[src*="dealsneartome.com"]')||(b.__cads__?!0:!1)||0<d.querySelectorAll('img[src*="/tracker?tag="]').length;e(28,17,t||!1)}return{f:c,
s:f}}catch(l){return null}}function T(){try{var b=z(),c=0,f=b.document;b==window.top&&""==f.title&&!f.querySelector("meta[charset]")&&f.querySelector('div[style*="background-image: url("]')&&(f.querySelector('script[src*="j.pubcdn.net"]')||f.querySelector('span[class="ad-close"]'))&&(c+=Math.pow(2,6));return c}catch(e){return null}}function U(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var c=z(),f=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+
(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{f.cookie&&(b+="&fcl="+f.cookie.length)}catch(e){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));f.querySelectorAll&&(b+="&fec="+f.querySelectorAll("*").length)}return b}catch(e){return""}}var u=function(){function b(b,c){var h=[];c&&d.forEach(function(b){var d=dv_GetParam(c,b);""!==d&&
null!==d&&h.push(["dvp_"+b,d].join("="))});var g=window&&window._dv_win||{};g=g.dv_config=g.dv_config||{};g=dv_getDVBSErrAddress(g);var k=[e,f].join("="),n=["dvp_cert",m[b]].join("=");b=["dvp_jsErrMsg",b].join("=");g+=["/verify.js?ctx=818052&cmp=1619415&dvp_isLostImp=1&ssl=1",k,n,b,h.join("&")].join("&");(new Image(1,1)).src="https://"+g}var c=!1,f,e,d=["ctx","cmp","plc","sid"],k=w(),m={VerifyLoadJSONPCallbackFailed:1,VerifyFailedToLoad:2},g={onTimeout:function(d){c||b("VerifyLoadJSONPCallbackFailed",
d)}};g.reportError=b;g.isJSONPCalled=c;g.msTillJSONPCalled=3E3;window._dv_win[k]={globalScopeVerifyErrorHandler:g};return{setVersionData:function(b,c){e=b;f=c},setIsJSONPCalled:function(b){c=b},getIsJSONPCalled:function(){return c},onLoad:dv_onLoad,onError:dv_onError,uniqueKey:k}}();this.createRequest=function(){var b=!1,c=window._dv_win,f=0,e=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,f++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(v){b=
!1}a:{try{var k=c.$sf;break a}catch(v){}k=void 0}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(A(b)){a:{try{var m=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(v){}m=void 0}if(m&&!A(m)&&0==m.indexOf(b)){b=m;var g=!0}}e=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};d=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?
window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();m=d.script;this.dv_script_obj=d;this.dv_script=m;window._dv_win.dvbsProcessed.push(d);window._dv_win._dvScripts.push(m);var h=m.src;this.dvOther=0;this.dvStep=1;var t=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():w():w();d=window.parent.postMessage&&window.JSON;var l=
!0,u=!1;if("0"==dv_GetParam(h,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)u=!0;if(d&&0==u)try{var q=B(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+t);l=x(q)}catch(v){}q={};try{u=/[\?&]([^&]*)=([^&#]*)/gi;for(var n=u.exec(h);null!=n;)"eparams"!==n[1]&&(q[n[1]]=n[2]),n=u.exec(h);var p=q}catch(v){p=q}p.perf=this.perf;p.uid=t;p.script=this.dv_script;p.callbackName="__verify_callback_"+p.uid;p.tagObjectCallbackName="__tagObject_callback_"+
p.uid;p.tagAdtag=null;p.tagPassback=null;p.tagIntegrityFlag="";p.tagHasPassbackFlag="";0==(null!=p.tagformat&&"2"==p.tagformat)&&(n=L(p.script),p.tagAdtag=n.tagAdTag,p.tagPassback=n.tagPassback,n.isBadImp?p.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(p.tagHasPassbackFlag="&tagpb=1"));(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?q="https:":(q=p.script.src,h="http:",
t=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=q.match("^https")||"https"!=t&&"http"==t||(h="https:"),q=h);p.protocol=q;p.ssl="0";"https:"===p.protocol&&(p.ssl="1");q=p;(h=window._dv_win.dvRecoveryObj)?("2"!=q.tagformat&&(h=h[q.ctx]?h[q.ctx].RecoveryTagID:h._fallback_?h._fallback_.RecoveryTagID:1,1===h&&q.tagAdtag?document.write(q.tagAdtag):2===h&&q.tagPassback&&document.write(q.tagPassback)),q=!0):q=!1;if(q)return{isSev1:!0};this.dvStep=2;K(p,n);m=m&&m.parentElement&&m.parentElement.tagName&&
"HEAD"===m.parentElement.tagName;this.dvStep=3;return E(this,p,b,c,f,e,d,l,m,n,g,k)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");if(u)try{u.setVersionData(this.getVersionParamName(),this.getVersion()),c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body,u.onLoad,u.onError,u.uniqueKey):dv_sendScriptRequest(b,u.onLoad,u.onError,u.uniqueKey)}catch(l){c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b)}else c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,
document.body):dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var f=I(this.dv_script_obj&&this.dv_script_obj.injScripts),e=B("about:blank");e.id=e.name;var d=e.id.replace("iframe_","");e.setAttribute&&e.setAttribute("data-dv-frm",d);x(e,this.dv_script);if(this.dv_script){var k=this.dv_script;a:{b=null;try{if(b=e.contentWindow){var m=b;break a}}catch(l){}try{if(b=window._dv_win.frames&&window._dv_win.frames[e.name]){m=b;break a}}catch(l){}m=null}k.dvFrmWin=m}a:{var g;if(e&&(g=e.contentDocument||
e.contentWindow&&e.contentWindow.document)){var h=g;break a}h=(g=window._dv_win.frames&&window._dv_win.frames[e.name]&&window._dv_win.frames[e.name].document)?g:null}if(h)h.open(),h.write(f);else{try{document.domain=document.domain}catch(l){}var t=encodeURIComponent(f.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));e.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+t+"');})()"}}}catch(l){f=window._dv_win.dv_config=window._dv_win.dv_config||
{},f=dv_getDVBSErrAddress(f),e=[this.getVersionParamName(),this.getVersion()].join("="),f+=["/verify.js?ctx=818052&cmp=1619415&dvp_cert=3&num=6",e].join("&"),dv_SendErrorImp(f,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(l)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=E);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"132"}};
...
try {
	...
	dv_handler132.prototype = dv_baseHandlerIns;
dv_handler132.prototype.constructor = dv_handler132;

    var dv_handlersDefs = [{handler: new dv_handler132(), minRate: 0, maxRate: 90}];
