...
namespace RegularExpressions
{
    class Program
    {
        ...
        {
            /*
            Литералы из точных строк начинаются со знака @ и заключены в двойные кавычки,
            Преимущество точных строк заключается в том, что escape-последовательности
            не обрабатываются
            */
