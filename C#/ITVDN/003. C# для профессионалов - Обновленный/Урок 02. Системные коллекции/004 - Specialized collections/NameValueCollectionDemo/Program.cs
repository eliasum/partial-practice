...
namespace NameValueCollectionDemo
{
    class Program
    {
        static void Main()
        {
            ...
            // NameValueCollection - коллекция, в которой для каждого ключа может быть несколько значений value
            ...
            // получить значения values для каждого ключа
            ...
            // данные файла конфигурации App.config текущего приложения 
