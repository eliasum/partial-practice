...
{
    /*
        создать открытый класс делегат PressKeyEventHandler(). Метод, который будет сообщён 
    ...
    */
    ...
    {
        /*
            создать открытые события PressKeyA и PressKeyB типа PressKeyEventHandler, 
            которые будут ссылаться на делегат типа PressKeyEventHandler. Ссылка будет 
            предоставлена событиям PressKeyA и PressKeyB на экземпляре класса Keyboard
        */
