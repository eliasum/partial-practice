...
# Однако функция необязательно должна возвращать именно данные в формате json.
...
# является то, что он позволяет также отправить ответ, который не покрывается
# встроенными классами, например, в каком-то нестандартном формате. Для определения
...
# В данном случае клиенту отправляется обычная строка "Hello METANIT.COM".
