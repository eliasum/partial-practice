//Generated:2021-03-31 10:15:22// 6-244
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_5337429 || '',
    guid: window.ftGUID_5337429 || '',
    confID: window.ftConfID_5337429 || '0',
    ftReturn: window.ftReturn_5337429 || '',
    keyword: window.ftKeyword_5337429 || '',
    ftId: window.ftId_5337429 || '',
    ftImpId: window.ftImp5337429 && window.ftImp5337429.impID || '',
    gdpr: window.ftImp5337429 && window.ftImp5337429.gdpr || '',
    gdpr_consent: window.ftImp5337429 && window.ftImp5337429.gdpr_consent || '',
    gdpr_pd: window.ftImp5337429 && window.ftImp5337429.gdpr_pd || '',
    us_privacy: window.ftImp5337429 && window.ftImp5337429.us_privacy || '',
    campaignID: '115750',
    cID: '116327',
    pID: '5337429',
    creativeID: '3336449',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115750&sid=18330&plc=5337429&num=&adid=&advid=&adsrv=29&btreg=5337429&btadsrv=flashtalking&crt=3336449&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/115750;5337429;3336449;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/ru/ru/free-trial-download.html?sdid=7RZ367W3&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?198887446-5337429;3336449;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/533/5337429/3336449/image/3336449.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115750;5337429;202;pixel;DV360;DV360FY20AcrobatCTXInMarketHighReachRUDSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/115750;5337429;3336449;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/ru/ru/free-trial-download.html?sdid=7RZ367W3&mv=display',
    divID: 'ftdiv5337429',
    altimgID: 'ftalt5337429',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp5337429 && parseInt(window.ftImp5337429.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m5337429') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m5337429'),
    pageVisible: 'maybe',
...
//622-5
(function(o) {
    o.blockBrowsers = 'ie8'.split(',');
    o.frameID = 'ftframe5337429';
    o.file = 'http://cdn.flashtalking.com/116327/3336449/index.html';
    o.altImg = 'http://servedby.flashtalking.com/imp/8/115750;5337429;204;gif;DV360;DV360FY20AcrobatCTXInMarketHighReachRUDSKBAN728x90/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_5337429").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_5337429").style.display = "none";
		    }
		});
	}
}(ft5337429));
...
(function(o){
    var max = 1000; //toggle this value for rate of fire
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115750&l2=DV360&l3=5337429&l4=3336449&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115750&l2=DV360&l3=5337429&l4=3336449&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
